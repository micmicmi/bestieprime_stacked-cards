...
def update_html():
    ...
    css_start_marker = "/* Split Layout Container */"
    css_end_marker = "/* Landing Page Styles */"
    ...
    # 2. Replace HTML using regex with strict end anchor
    ...
    # We match from <div class="cards-area-wrapper"> all the way to the <!-- Section 3 --> that precedes <section class="lp-two-col">
    content = re.sub(
        r'<div class="cards-area-wrapper">.*?<!-- Section 3 -->\s*<section class="lp-two-col">',
